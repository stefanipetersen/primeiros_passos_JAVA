package src.Heranca.view;

import src.Heranca.model.Enderecos;
import src.Heranca.model.Programador;
...
public class ViewProgramador {
    ...
    private static Programador cadastrarProgramador() {
        ...
        programador.setNomes(sc.nextLine());
        ...
        programador.setEnderecos(new Enderecos(sc.nextLine(),
